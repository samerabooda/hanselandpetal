...
$seasons = array(
	...
	foreach($seasons AS $key => $arraymonth){
	if(in_array($monthname,$arraymonth)){
		$season = $key;
		break;
	}	
    ...
    <div id="content">
        <div id="col_1" role="main">
            ...
            <div id="feature" class="pull_out lg_margin">
                <div class="inner">
                    <p class="overlay large"><?= $features[$season]; ?></p>
                    <p class="overlay price">Starting at $45.95</p>
                    <img src="images/feature_<?= $season; ?>.jpg" alt="White Rose Arrangement" height="410" width="980"> </div>
            </div>
            <div class="section">
            ...
            <div class="section">
                ...
                <ul class="reset tiles x2">
                    ...
                    <li> <a href="#" class="tile border">
                        ...
                        <img src="images/special_<?= $monthname; ?>.jpg" alt="<?= $alt[$monthnum-1]; ?>" height="200" width="450"> </a> </li>
                </ul>
            </div>
        </div>
    </div>
