      ...
      <div id="footer">
        <div class="row clearfix">
            <ul class="reset menu hover">
                <li><a href="<?= $siteroot ;?>/arrangements.php">Arrangements</a></li>
                <li><a href="#">Live Plants</a></li>
                <li><a href="<?= $siteroot ;?>/bouquet.php">Build-a-Bouquet</a></li>
                <li><a href="#">Special Events</a></li>
                <li><a href="#">Care Tips</a></li>
                <li><a href="#">Eco-Conscious</a></li>
                <li><a href="<?= $siteroot ;?>/designers.php">Our Designers</a></li>
            </ul>
            <ul class="reset menu hover">
            ...
            <img src="<?= $siteroot ;?>/images/logo.png" alt="Hansel and Petal" height="124" width="207"> </div>
        <p id="copyright" class="reset pull_out padding" role="contentinfo"><a href="<?= $siteroot ;?>/index.php">© <?= Copyright(2018); ?> Hansel and Petal</a></p>
