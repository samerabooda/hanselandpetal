<?php $siteroot = '/hanselandpetal'  ?>
       

        
     <div id="header" role="banner">
        <h1 id="logo"><a href="<?= $siteroot ;?>/index.php"><img src="<?= $siteroot ;?>/images/logo.png" alt="Hansel and Petal" height="124" width="207"></a></h1>
        <div class="inner">
            <ul id="quick_links" class="reset menu">
                <li><a href="#">My Account</a></li>
                <li><a href="<?= $siteroot ;?>/order.php">View My Order</a></li>
    ...
    <div id="nav_main" role="navigation" class="reset menu pull_out">
        <ul>
            <li> <a href="<?= $siteroot ;?>/arrangements.php" class="parent"><span>Arrangements</span></a>
                <div>
                    <ul>
            ...
            <li><a href="<?= $siteroot ;?>/bouquet.php"><span>Build-a-Bouquet</span></a></li>
            ...
            <li> <a href="#" class="parent"><span>Care Tips</span></a>
                <div class="single_column">
                    <ul>
                        ...
                        <li><a href="<?= $siteroot ;?>/care/orchids.php">Caring for Orchids</a></li>
                    </ul>
                </div>
            </li>
            <li><a href="#"><span>Eco-Conscious</span></a></li>
            <li><a href="<?= $siteroot ;?>/designers.php"><span>Our Designers</span></a></li>
        </ul>
    </div>